package funplay.nativeapp.rps.customviews.fab;
    ...
    private void addViewToCurrentContainer(View view, ViewGroup.LayoutParams layoutParams) {
        if (systemOverlay) {
            ...
            try {
                ...
                throw new ClassCastException("layoutParams is a " + layoutParams.getClass().getSimpleName() + ",must be an instance of " +
